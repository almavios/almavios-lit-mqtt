...
bool LitCloudAzureApi::connect(PubSubClient& mqtt){
  return mqtt.connect(this->iot_device_id, this->iot_hub_user.c_str(), "");
}

std::string LitCloudAzureApi::getMainSubTopic(){
  return this -> getShieldSubTopic(this->iot_device_id);
}

std::string LitCloudAzureApi::getMainPubTopic(){
...
std::string LitCloudAzureApi::getShieldSubTopic(const char* topic){
  std::string helper = std::string("devices/") 
                        + std::string(topic) 
                        + std::string("/messages/devicebound/#");
  return helper;                      
}

std::string LitCloudAzureApi::getShieldPubTopic(const char* topic){
  std::string helper = std::string("devices/") 
                        + std::string(topic) 
                        + std::string("/messages/events/");
  return helper;
}
...
unsigned char LitCloudAzureApi::provider_cert[] = {
